    ...
    return (
        <section className="-mx-[calc(50vw-50%)] w-screen min-h-svh p-8">
            ...
            <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-12 gap-8">
                <div className="md:col-span-6 rounded-2xl p-6
                ...
                <div className="md:col-span-6 rounded-2xl p-6 flex flex-col gap-8">
                    ...
                    <div className="rounded-2xl bg-black p-6 text-white">
                        ...
                        <p className="leading-relaxed opacity-90">
                            ...
                            dine sidste spørgsmål kan besvares af vores <a href="/faq" className="text-green-500
