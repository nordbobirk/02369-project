...
describe("Calendar20", () => {
  beforeEach(() => {
    ...
    const mockAvailability = [
      { date: new Date('2023-11-15T00:00:00Z'), is_open: true },
      { date: new Date('2023-11-16T00:00:00Z'), is_open: true },
    ];
    
    const mockBookings = [
      { id: "1", date_and_time: new Date('2023-11-15T10:00:00Z'), total_duration: 60 },
      { id: "2", date_and_time: new Date('2023-11-15T11:30:00Z'), total_duration: 60 },
    ];
